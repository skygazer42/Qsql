...
# from qsql.pgvector import PG_VectorStore
# from qsql.openai import OpenAI_Chat
...
#     # configure QSQL to use OpenAI and PGVector
...
#     vn.connect_to_sqlite("https://example.com/Chinook.sqlite")
...
#     # test if QSQL can generate an answer
